...
if (is_array($groups)) {
	...
	foreach ($groups as $idx => $group) {
		...
		$this->table->add_row([
			['data' => $sort_html, 'data-label' => ''],
			['data' => $name_html, 'data-label' => lang('room_group.field.name')],
			['data' => $rooms_html, 'data-label' => lang('room.rooms')],
			['data' => $description_html, 'data-label' => lang('room_group.field.description')],
