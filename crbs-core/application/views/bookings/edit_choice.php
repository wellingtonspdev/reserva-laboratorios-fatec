...
$buttons[] = form_button([
	...
	'class' => 'cps-btn-primary w-full mb-2',
...
$buttons[] = form_button([
	...
	'class' => 'cps-btn-primary w-full mb-4',
	'up-href' => site_url($uri),
	'up-target' => '.bookings-edit',
	'up-layer' => 'new modal',
]);

$cancel = "<div class='text-center'><a href='#' up-dismiss class='cps-btn-secondary w-full'>" . lang('app.action.cancel') . "</a></div>";
