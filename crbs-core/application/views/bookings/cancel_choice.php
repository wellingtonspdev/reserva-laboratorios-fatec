...
if ($booking->repeat_id) {
	...
	$buttons[] = form_button([
		...
		'name' => 'cancel',
		'value' => '1',
		'class' => 'cps-btn-danger w-full mb-2',
	...
	$buttons[] = form_button([
		...
		'name' => 'cancel',
		'value' => 'all',
		'class' => 'cps-btn-danger w-full mb-4',
		'content' => lang('booking.selection.all'),
	]);

	$cancel = "<div class='text-center'><a href='#' up-dismiss class='cps-btn-secondary w-full'>" . lang('booking.cancel.abort') . "</a></div>";
	...
	$submit = form_button([
		...
		'name' => 'cancel',
		'value' => '1',
		'class' => 'cps-btn-danger',
		'content' => lang('booking.cancel.single.action'),
		'autofocus' => true,
	]);

	$cancel = "<a href='#' up-dismiss class='cps-btn-secondary'>" . lang('booking.cancel.abort') . "</a>";

	$content = "<div class='flex items-center gap-3'>{$cancel}{$submit}</div>";
}
